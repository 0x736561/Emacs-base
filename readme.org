...
;; A "tela inicial" já faz o que está aqui embaixo
...
Um modo que substitui outros minor-modes e que providência auto-completação de texto
...
cliente gpg nativo do Emacs, ele é usado na configuração de email e também no cliente irc.
